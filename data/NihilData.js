...
export const NihilClothesData = {
  ...
  male: {
    top: [
      ...
      '판금 전신 갑옷', '청동 전신 갑옷', '강철 전신 갑옷', '소매가 긴 의상', '소매가 넓은 의상',
      '소매가 긴 팔토시', '소매가 넓은 팔토시', '가슴 노출이 있는 민소매 기반', '크롭 의상', '손에 붕대를 감음',
      '손목까지 붕대를 감음',
    ...
    bottom: [
      ...
      '벨트가 있는 바지', '갑옷 하의 풀세트', '하반신 전체가 세트인 의상',
    ...
    shoes: shoesMale.map(item => `${item} 기반`).concat(shoesCommon.map(item => `${item} 기반`), [
      '맨발', '발에 붕대를 감음', '맨발 + 한쪽 발에만 붕대를 감음', '굽 높은 신발 기반', '힐 기반',
      '운동화 기반', '슬리퍼 기반', '갑옷 장화 기반', '굽 낮은 신발 기반', '맨발 + 한쪽 발에만 천을 감음',
      '캔버스화 기반', '샌들 기반', '장화 기반', '발에 천을 감음', '발가락이 드러나는 천을 감음',
      '발목까지 오는 신발', '무릎까지 오는 신발', '무릎 위로 올라오는 신발',
  ...
  female: {
    top: [
      ...
      '민소매 + 한쪽 팔토시', '목 보호대', '목 보호대 + 복대', '드레스 기반', '소매가 긴 의상',
      ...
      '짧은 블라우스 기반', '판금 전신 갑옷', '청동 전신 갑옷', '강철 전신 갑옷', '소매가 넓은 의상',
      '소매가 긴 팔토시', '소매가 넓은 팔토시', '가슴 노출이 있는 민소매 기반', '크롭 의상', '손에 붕대를 감음',
      '손목까지 붕대를 감음',
    ...
    bottom: [
      ...
      '벨트가 있는 스커트', '갑옷 하의 풀세트', '하반신 전체가 세트인 의상',
    ...
    shoes: shoesFemale.map(item => `${item} 기반`).concat(shoesCommon.map(item => `${item} 기반`), [
      '맨발', '발에 붕대를 감음', '맨발 + 한쪽 발에만 붕대를 감음', '굽 높은 신발 기반', '힐 기반',
      '운동화 기반', '슬리퍼 기반', '갑옷 장화 기반', '굽 낮은 신발 기반', '맨발 + 한쪽 발에만 천을 감음',
      '캔버스화 기반', '샌들 기반', '장화 기반', '발에 천을 감음', '발가락이 드러나는 천을 감음',
      '발목까지 오는 신발', '무릎까지 오는 신발', '무릎 위로 올라오는 신발',
