...
export const RandomKeywordData = {
    ...
    '고대의 문명', '분열', '증식', '단세포', '멜트다운',
    '해저드', '위선자', '위악자', '가슴 사이즈', '복제',
    '염색약', '립밤', '립스틱', '마스카라', '아이라인',
    '무기', '갑옷', '리본', '망사', '스타킹',
    '노출', '작위', '19금', '시공간', '도형',
    ...
    '스포츠', '축구', '농구', '배구', '테니스',
    '배드민턴', '체스', '바둑', '오목', '장기',
    '장기말', '바둑알', '게임', '보드게임', '스케이트',

    '스쿠터', '보트', '기억력', '암기력', '(뭔가를)방출',
    '(뭔가를)흡수', '고무', '공허', '굴절', '날씨',
    '눈(기상)', '땅', '레이저', '먼지', '모래',
    '반사', '부식', '산성', '섬유', '소리',
    '속도', '수정', '실', '심안', '안개',
    ...
    '유전자', '음파', '장력', '정신', '진공',
    '진동', '체력', '폭풍우', '플라즈마', '향기',
    '흙', '서버 컴퓨터', '로봇', '안드로이드', '서버',
    '원자력', '원자', '분자', '입자',  '소립자',

    '초소립자', '데이터', '데이터베이스', '프로그램', '화학',
    '생물학', '생물', '사물', '도구', '생명체',
    '심리', '내면', '자아', '초자아', '설원',
    '사막', '숲', '하늘', '물리학', '우주과학',
    '악동', '말썽꾸러기', '말괄량이', '행동', '계획',
    ...
    '인어', '별자리', '황도 12궁', '순결', '권력자',
    '환한 웃음', '죄', '죄인', '마지막', '처음',
    '자유', '갈망', '금단의 영역', '금지', '금기',
    '도살', '살육', '도살자', '살충', '파도',
    '기포', '금지된 실험', '연구자', '금지된 연구',
    '모노클 렌즈', '고스트', '관음증', '기괴', '노출광',
    '도화지', '마스크', '마우스', '명계', '브래지어',
    '비키니', '시공', '야광봉', '염색', '염색체',
    '요정', '칼', '가위', '커터칼', '과도',
    '식칼', '네트워크', '랜(LAN)', '인터넷', '절단',

    '사멸', '사명', '소명', '책임감', '명령권',
    '절멸', '가상현실(VR)', '증강현실(AR)', '도플갱어', '아이섀도우',
    '네일아트', '속눈썹', '장갑', '넝마', '매니큐어',
    '파옥', '페디큐어', '핵분열', '핵폭발', '원자폭발',
    '타입', '꽃가루', '여의주', '도깨비불', '도깨비뿔',

    '도깨비 방망이', '쿼터(혼혈)', '용의 구슬', '괴수', '반인반수',
    '하프(혼혈)', '상상의 동물', '환상종',
  ],
  creature: [
    '환상종/사신-청룡', '환상종/사흉-궁기', '환상종/사흉-도철', '환상종/사흉-혼돈', '환상종/사흉-도올',
    '환상종/사신-주작', '환상종/사신-백호', '환상종/사신-현무', '환상종/피닉스', '환상종/삼족오',
    '환상종/해태', '환상종/사령-응룡', '환상종/야마타노 오로치', '환상종/사령-기린', '환상종/사령-봉황',
    '환상종/사령-영귀', '환상종/베누', '환상종/베헤모스', '환상종/바하무트', '환상종/불사조',
    '환상종/스핑크스', '환상종/오룡-청룡', '환상종/오룡-흑룡', '환상종/오룡-황룡', '환상종/오룡-백룡',
    
    '환상종/오룡-적룡', '환상종/야타가라스', '환상종/가루다', '환상종/레비아탄', '환상종/그리폰',
    '환상종/바실리스크', '환상종/만티코어', '환상종/샐러맨더', '환상종/크라켄', '환상종/히포그리프',
    '환상종/타라스크', '환상종/고르곤', '환상종/퀴클롭스', '환상종/미노타우로스', '환상종/메두사',
    '환상종/네메아의 사자', '환상종/케르베로스', '환상종/키메라', '환상종/티폰', '환상종/히드라',
    '환상종/흐레스벨스', '환상종/펜리르', '환상종/니드호그', '환상종/라타토스크', '환상종/파프니르',
    
    '환상종/슬레이프니르', '환상종/요르문간드', '환상종/오르토스', '환상종/기간테스', '환상종/스킬라',
    '환상종/라돈', '환상종/에키드나',
  ],
  breastSize: [
    '가슴 사이즈/무유(無乳)', '가슴 사이즈/미유(微乳)', '가슴 사이즈/빈유(貧乳)', '가슴 사이즈/평유(平乳)', '가슴 사이즈/거유(巨乳)',
    '가슴 사이즈/폭유(爆乳)', '가슴 사이즈/초유(超乳)',
  ],
  race: CharacterData.race.map(value => {
    return `종족/${value}`;
  }),
  zodiac: [
    '12궁/백양궁(백양자리)', '12궁/금우궁(황소자리)', '12궁/쌍아궁(쌍둥이자리)', '12궁/거해궁(게자리)', '12궁/사자궁(사자자리)',
    '12궁/처녀궁(처녀자리)', '12궁/천칭궁(천칭자리)', '12궁/천갈궁(전갈자리)', '12궁/인마궁(사수자리)', '12궁/마갈궁(염소자리)',
    '12궁/보병궁(물병자리)', '12궁/쌍어궁(물고기자리)', '12궁/사견궁(뱀주인자리)', '12궁/아리에스(백양자리)', '12궁/타우러스(황소자리)',
    '12궁/제미니(쌍둥이자리)', '12궁/캔서(게자리)', '12궁/레오(사자자리)', '12궁/비르고(처녀자리)', '12궁/라이브라(천칭자리)',
    '12궁/스콜피온(전갈자리)', '12궁/사지타리우스(사수자리)', '12궁/카프리콘(염소자리)', '12궁/아쿠에리어스(물병자리)', '12궁/피스케스(물고기자리)',

    '12궁/오퓨크스(뱀주인자리)',
  ],
  asteria: ZodiacData.map(value => {
    return `별자리/${value}`;
  }),
  sins: [
    '칠죄종/식탐', '칠죄종/욕망', '칠죄종/오만', '칠죄종/나태', '칠죄종/색욕',
    '칠죄종/질투', '칠죄종/분노',
  ],
  tool: [
  ...
  job: CharacterData.class.real.concat(CharacterData.class.fantasy).map(value => {
    return `직업/${value}`;
  }),
  type: CharacterData.characterImage.map(value => {
    return `타입/${value}`;
  }),
  metal: [
  ...
  body: [
    ...
    '신체/혀', '신체/검은자위', '신체/흰자위', '신체/왼손', '신체/오른손',
  ],
  ...
  weapon: CharacterData.weapon.map(
    ...
    '무기/쌍장창', '무기/망치', '무기/전쟁 망치', '무기/백린탄', '무기/소이탄',
    '무기/원자폭탄', '무기/수소폭탄', '무기/중성자탄',
  ]),
  ...
  state: [
    ...
    '특징/무술을 잘하는', '특징/무술을 못하는', '특징/낡은', '특징/찬란한', '특징/자유로운',
    '특징/공정한', '특징/풍족한', '특징/냉정한', '특징/외로운', '특징/기세등등한',
    '특징/이상한', '특징/피곤하게 구는', '특징/악한', '특징/괴로운', '특징/아픈',
    '특징/친숙한', '특징/장엄한', '특징/야비한', '특징/완전한', '특징/절대적인',

    '특징/완성된', '특징/관대한', '특징/대담한', '특징/소름돋는', '특징/소름끼치는',
    '특징/오싹한', '특징/기분 좋은', '특징/기쁜', '특징/가슴이 큰', '특징/가슴이 작은',
    '특징/고혹적인', '특징/고풍스러운', '특징/고급진', '특징/고급스러운', '특징/고급적인',
  ],
};