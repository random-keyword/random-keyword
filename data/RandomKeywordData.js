...
export const RandomKeywordData = {
    ...
    '인어', '별자리', '황도 12궁', '백양궁(백양자리)', '금우궁(황소자리)',
    '쌍아궁(쌍둥이자리)', '거해궁(게자리)', '사자궁(사자자리)', '처녀궁(처녀자리)', '순결',
    '천칭궁(천칭자리)', '천갈궁(전갈자리)', '인마궁(사수자리)', '마갈궁(염소자리)', '보병궁(물병자리)',
    '쌍어궁(물고기자리)', '사견궁(뱀주인자리)', '아리에스(백양자리)', '타우러스(황소자리)', '제미니(쌍둥이자리)',
    '캔서(게자리)', '레오(사자자리)', '비르고(처녀자리)', '라이브라(천칭자리)', '스콜피온(전갈자리)',

    '사지타리우스(사수자리)', '카프리콘(염소자리)', '아쿠에리어스(물병자리)', '피스케스(물고기자리)', '오퓨크스(뱀주인자리)',
    '환한 웃음', '죄', '죄인', '마지막', '처음',
  ],
  tool: [
